...
slug: "b7_behandlung_ambivalenz"
source_pdf: "/handouts/b7_behandlung_ambivalenz.pdf"
status: "draft"
...
quick_steps:
  - icon: "Ruhe"
    text: "Nicht im Streit über Behandlung diskutieren"
  - icon: "i"
    text: "Beobachtungen dokumentieren und Behandlungsteam informieren"
  - icon: "Plan"
    text: "In stabileren Phasen Gründe, Grenzen und Plan B klären"
visual_model:
  kind: "triage"
  title: "Gesprächsspielraum oder Notfallpfad?"
  note: "Ambivalenz ist nicht automatisch fehlende Einsicht. Entscheidend ist, wie viel Kontakt, Realitätssinn und Sicherheit noch vorhanden sind."
  items:
    - label: "Stabilerer Moment"
      text: "Gründe, Nebenwirkungen, Ängste und Vereinbarungen ruhig besprechen."
    - label: "Warnzeichen"
      text: "Veränderungen dokumentieren und Behandlungsteam informieren."
    - label: "Behandlungsabbruch"
      text: "Plan B klären, ohne heimlich zu kontrollieren oder Druck zu erzwingen."
    - label: "Akute Gefahr"
      text: "Nicht weiter debattieren; Notfallseite, 144 oder Notfalldienst nutzen."
emergency_contacts:
  - label: "Notfalldienst Zürich"
    number: "0800&nbsp;33&nbsp;66&nbsp;55"
    note: "Wenn Unsicherheit in Gefahr kippt oder Sie fachliche Einschätzung brauchen"
  - label: "Sanität"
    number: "144"
  ...
  - label: "Notfallseite"
    number: "/notfall/"
    note: "Wenn Schutz jetzt Vorrang hat"
---
...
- [Modul 6: Wenn Krankheitseinsicht fehlt oder Behandlung scheitert](/modul/6/#einsicht)
- [Modul 6: Medikamente absetzen](/modul/6/#medikamente-absetzen)
- [Krisenplan-Werkzeug](/tools/krisenplan/)
