...
slug: "c1_krisenplan"
source_pdf: "/handouts/c1_krisenplan.pdf"
status: "draft"
...
emergency_contacts:
  - label: "Notfalldienst Zürich"
    ...
    note: "Wenn sich die Lage zuspitzt und Sie sofort fachliche Einschätzung brauchen"
  - label: "Sanität"
    number: "144"
  ...
  - label: "Notfallseite"
    number: "/notfall/"
    note: "Wenn Sie die nächsten Schritte im Ernstfall strukturieren müssen"
---
...
## Wie Sie das Gespräch anfangen können

Hilfreicher als Druck ist ein ruhiger Einstieg wie:
**„Wann wäre ein guter Zeitpunkt, über den Krisenplan zu reden?“**

Das gibt der anderen Person Kontrolle über den Zeitpunkt zurück. Sinnvoll ist auch, pro Gespräch nur ein Thema zu klären, statt den ganzen Plan auf einmal zu erzwingen.
...
- [Krisenplan-Vorlage](/downloads/krisenplan-vorlage-bipolare-stoerung-puk-zuerich.pdf)
- [Modul 6: Kommunikation in stabilen und akuten Phasen](/modul/6/)
