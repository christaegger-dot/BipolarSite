...
| Aktive Web-Handouts | 26 | Hauptquelle für die Migration. |
| Legacy-Aliasse | 4 | Behalten, solange alte Direktlinks existieren. |
| Markdown-Drafts | 29 | Inhaltliche Rohquelle, nicht ungeprüft übernehmen. |
| Neue A4-quer-Referenzen | 7 | `a1_bipolare_stoerung_verstehen`, `a8_warnsignale`, `a3_ambivalente_loyalitaet`, `a4_ambiguous_loss`, `a9_schlaf_fruehwarnsystem`, `b11_hypervigilanz_erschoepfung`, `c6_selbstfuersorge`. |
